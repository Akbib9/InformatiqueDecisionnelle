        ...
        for direction in 'WSEN':
            if infoNode[direction] == 1:
                ...
                if node2 == goal:
                    ...
                    return kidpath
        print("Voici la file non triée: ",queue)
        queue = sorting(queue, graph) #Tri de la queue entière après insertion des noeuds enfants
        print("Voici la file après le tri: ",queue)
